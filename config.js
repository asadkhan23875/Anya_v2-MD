...
module.exports = {
     ...
     */
    botname: process.env.BotName || "A S A D H E R E ",
    footer: process.env.Footer || "© Powered By ASAD HERE Bot",
     ...
     */
    ownername: process.env.Owner_Name || "ASAD HERE",
    ownernumber: process.env.Owner_Number || "923482879909",
    instagramId: process.env.Insta || "",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@asadhere",
    packname: process.env.PackName || "ASAD HERE v2 MD",
    ...
    mongoUrl: process.env.MongoDB || "mongosh "mongodb+srv://cluster0.bw4yw.mongodb.net/" --apiVersion 1 --username hanifkamran020",
    sessionId: process.env.SESSION_ID || "dW1yYzl_AN_YA_6aW8=",
